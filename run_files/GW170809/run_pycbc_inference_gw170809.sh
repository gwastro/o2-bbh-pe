...
# wget https://www.gw-openscience.org/catalog/GWTC-1-confident/data/GW170809/H-H1_GWOSC_16KHZ_R1-1186300472-4096.gwf
# wget https://www.gw-openscience.org/catalog/GWTC-1-confident/data/GW170809/L-L1_GWOSC_16KHZ_R1-1186300472-4096.gwf
# wget https://www.gw-openscience.org/catalog/GWTC-1-confident/data/GW170809/V-V1_GWOSC_16KHZ_R1-1186300472-4096.gwf

# pycbc_inference can also be run on multiple machines using MPI for which add --use-mpi to the command line below

pycbc_config_file=gw170809_inference.ini
pycbc_output_file=gw170809_posteriors.hdf

# data
FRAMES="H1:H-H1_GWOSC_16KHZ_R1-1186300472-4096.gwf L1:L-L1_GWOSC_16KHZ_R1-1186300472-4096.gwf V1:V-V1_GWOSC_16KHZ_R1-1186300472-4096.gwf"
CHANNELS="H1:GWOSC-16KHZ_R1_STRAIN L1:GWOSC-16KHZ_R1_STRAIN V1:GWOSC-16KHZ_R1_STRAIN"

# trigger parameters
TRIGGER_TIME=1186302519.8
...
PSD_STRIDE=4
PSD_DATA_LEN=1024
PSD_GATE="H1:1186302519.0:2.0:0.5 L1:1186302519.0:2.0:0.5 V1:1186302519.0:2.0:0.5"
